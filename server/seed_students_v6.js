    ...
    try {
        ...
        for (let i = 0; i < 100; i++) {
            ...
            await Student.create({
                ...
                department: deptObj.name,
                attendance: 55 + Math.floor(Math.random() * 40), // More spread for risk tracking
        ...
        // Add 1 audit log entry for the seed
        await AuditLog.create({
            admin: admin._id,
            action: 'System Seed Complete',
            details: 'Initialized the institution with 4 departments, 100 students, and faculty tracking data.'
        });

        console.log('Successfully re-seeded with Faculty and Audit Logs.');
        process.exit();
    } catch (err) {
